    ...
    <script type="module">
        ...
        async function handleSignup() {
            ...
            setTimeout(() => {
                ...
                setState({ appUserData: { name: name.toUpperCase(), walletBalance: 200 }, isLoggedIn: true, isProcessing: false, bannerClaimed: false });
                    ...
                    <div class="fixed inset-0 z-[200] bg-black/70 backdrop-blur-sm flex items-center justify-center p-8">
                        <div class="bg-white rounded-[2.5rem] w-full max-w-sm p-8 text-center space-y-6 banner-pop shadow-2xl border-t-8 border-orange-600">
                            <div class="w-20 h-20 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center mx-auto mb-2">
                                <i data-lucide="gift" size="40"></i>
                            </div>
                            <h2 class="font-black text-xl text-gray-800 uppercase tracking-tight">Gift from CEO</h2>
                            <p class="text-[12px] font-bold text-gray-500 leading-relaxed px-2 italic">
                                "Congratulations, you have received 200 naira gift from Capacity Nigtech CEO Mr. AUWAL TUKUR. Thank you for choosing us."
                            </p>
            ...
            if (state.activeTab === 'home') {
                return `
                    <div class="p-5 space-y-6 animate-in fade-in slide-in-from-right-4">
                        ...
                        <!-- REORGANIZED CONTACT SECTION DIRECTLY BELOW USSD -->
                        ...
                        <div class="space-y-3">
                            <h4 class="text-[10px] font-black text-gray-400 uppercase tracking-widest px-2">Other Services (Locked)</h4>
                            <div class="space-y-2 opacity-60">
                                <div class="flex items-center justify-between bg-white border border-gray-100 p-4 rounded-2xl shadow-sm">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div class="flex flex-col"><span class="text-[10px] font-black uppercase">Airtime</span><span class="text-[8px] font-bold text-gray-400 uppercase italic">Locked</span></div>
                                    </div>
                                ...
                                <div class="flex items-center justify-between bg-white border border-gray-100 p-4 rounded-2xl shadow-sm">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div class="flex flex-col"><span class="text-[10px] font-black uppercase">Data Bundle</span><span class="text-[8px] font-bold text-gray-400 uppercase italic">Locked</span></div>
                                    </div>
                                    <i data-lucide="lock" size="12" class="text-gray-300"></i>
                                </div>
                            </div>
                        ...
                        <p class="text-[8px] font-bold text-gray-400 uppercase italic px-1 text-center py-4">"Shagon Kwalba Mai aski, hanyar yanoho."</p>
                    </div>`;
