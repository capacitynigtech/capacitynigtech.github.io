...
<head>
    ...
    <style>
        ...
        .nav-text { font-size: 8px; margin-top: 1px; }
        ...
        <div class="min-h-screen flex flex-col">
            ...
            <div class="flex mx-4 bg-slate-100 rounded-lg p-0.5 mb-2">
                <button id="tab-login-btn" onclick="showAuthTab('login')"
                    class="flex-1 py-1 rounded-md text-[9px] font-black uppercase tracking-wider transition-all bg-white text-slate-900 shadow-sm">
                    Login
                </button>
            ...
            <div id="auth-login" class="px-4 flex flex-col gap-1.5">
                ...
                <button onclick="logIn()"
                    class="w-full bg-orange-500 text-white py-2 rounded-lg font-black text-[10px] uppercase tracking-wider mt-1 active:scale-[0.98] transition-transform shadow-lg shadow-orange-500/20">
                    Login
                </button>
        ...
        <main class="px-4 space-y-4">
            <div id="content-area">
                    ...
                    <div class="pt-2">
                        ...
                        <div class="bg-[#f8fafc] border border-gray-100 p-3 rounded-[1.5rem] grid grid-cols-3 gap-y-3 gap-x-1 text-center shadow-sm">
                            ...
                            <div onclick="switchTab('offers')" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fas fa-robot text-[#f97316]" style="font-size:12px;width:12px;height:12px;"></i>
                                </div>
                            ...
                            <div onclick="handleInstallApp()" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fas fa-download text-[#f97316]" style="font-size:12px;width:12px;height:12px;"></i>
                                </div>
                            ...
                            <div onclick="switchTab('offers')" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fas fa-dice text-[#f97316]" style="font-size:12px;width:12px;height:12px;"></i>
                                </div>
                            ...
                            <div onclick="switchTab('offers')" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fab fa-bitcoin text-[#f97316]" style="font-size:12px;width:12px;height:12px;"></i>
                                </div>
                            ...
                            <div onclick="switchTab('offers')" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fas fa-graduation-cap text-[#f97316]" style="font-size:12px;width:12px;height:12px;"></i>
                                </div>
                            ...
                            <div onclick="switchTab('offers')" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fas fa-chart-line text-[#f97316]" style="font-size:12px;width:12px;height:12px;"></i>
                                </div>
                            ...
                            <div onclick="switchTab('offers')" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fas fa-gamepad text-[#f97316]" style="font-size:12px;width:12px;height:12px;"></i>
                                </div>
                            ...
                            <div onclick="handleSimpleTask()" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fas fa-check-circle text-[#f97316]" style="font-size:12px;width:12px;height:12px;"></i>
                                </div>
                            ...
                            <div onclick="switchTab('offers')" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fas fa-cubes text-[#f97316]" style="font-size:12px;width:12px;height:12px;"></i>
                                </div>
                ...
                <div id="view-offers" class="hidden space-y-4">
                    ...
                    <div id="task-wall-container" class="space-y-3">
                        <!-- Tasks rendered by renderTaskWall() -->
                    </div>
                </div>
                ...
                <div id="view-profile" class="hidden space-y-2 pt-4">
                    ...
                    <!-- Task Progress -->
                    <div class="bg-slate-50 rounded-2xl border border-slate-100 p-3 mb-1.5">
                        <h3 class="text-xs font-bold text-slate-800 uppercase tracking-wider mb-2">Task Progress</h3>
    ...
    <div id="support-modal" class="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/40 opacity-0 pointer-events-none transition-opacity">
        <div class="bg-white w-full max-w-xs rounded-2xl p-5 transform scale-90 transition-transform">
            ...
            <div class="space-y-2.5">
                ...
                <!-- Telegram -->
                <a href="https://t.me/+2349018511585" target="_blank" class="flex items-center gap-3 p-3 bg-[#e8f4fd] rounded-xl border border-blue-100 active:bg-blue-100 transition-colors">
                    <div class="w-8 h-8 rounded-lg bg-[#229ED9] flex items-center justify-center flex-shrink-0">
                        <i class="fab fa-telegram-plane text-white" style="font-size:16px;"></i>
                    </div>
                    <div>
                        <p class="text-[9px] font-black text-blue-500 uppercase tracking-wider">Telegram</p>
                        <p class="text-[11px] font-bold text-slate-700">Message us</p>
                    </div>
                    <i class="fas fa-arrow-right text-blue-300 ml-auto" style="font-size:10px;"></i>
                </a>
...
${user.referral ? '🔗 *Referred By:* ' + user.referral : '🔗 *Referred By:* None'}`;
        ...
        async function submitTaskProof(taskId) {
            ...
            const sub = {
                ...
                taskId: taskId,
                note,
                screenshot: '', // base64 not sent to JSONBin to avoid size limits
                status: 'pending',
            ...
            dbCache.submissions.push({
                id: sub.id, userId: sub.userId, userName: sub.userName,
                taskId: sub.taskId, note: sub.note, screenshot: '[image_uploaded]',
    ...
    <script>
        // ══════════════════════════════════════════
        // TASK WALL — Add/remove tasks here only
        // ══════════════════════════════════════════
        const TASK_LIST = [
            {
                id:          'testing',
                icon:        'fas fa-flask',
                name:        'Testing',
                description: 'Testing the task proof submission',
                reward:      '₦0'
            },
        ...
        function renderTaskWall() {
            const container = document.getElementById('task-wall-container');
            if (!container) return;
            if (!TASK_LIST.length) {
                container.innerHTML = `
                    <div class="py-12 text-center">
                        <div class="w-16 h-16 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-4 border border-slate-100">
                            <i class="fas fa-hourglass-half text-slate-300 text-xl"></i>
                        </div>
                        <p class="text-[11px] font-bold text-slate-400 uppercase tracking-widest">No Tasks Yet</p>
                        <p class="text-[10px] text-slate-400 mt-1">Check back later for new opportunities.</p>
                    </div>`;
                return;
            }
            container.innerHTML = TASK_LIST.map(t => `
                <div class="bg-slate-50 border border-slate-100 p-4 rounded-2xl">
                    <div class="flex items-center justify-between mb-3">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-orange-500 rounded-lg flex items-center justify-center text-white">
                                <i class="${t.icon}" style="font-size:14px;"></i>
                            </div>
                            <div>
                                <p class="text-[11px] font-bold text-slate-800">${t.name}</p>
                                <p class="text-[9px] text-slate-500">${t.description}</p>
                            </div>
                        </div>
                        <span class="text-[10px] font-black text-orange-500">${t.reward}</span>
                    </div>
                    <button onclick="openTaskSubmit('${t.name}', '${t.description}', '${t.reward}')"
                        class="w-full bg-orange-500 text-white py-1.5 rounded-lg font-black text-[10px] uppercase tracking-wider active:scale-[0.98] transition-transform">
                        Submit Proof
                    </button>
                </div>`).join('');
        }
