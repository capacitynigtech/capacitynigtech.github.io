...
<body class="pb-16">
    ...
    <div id="auth-screen" class="hidden fixed inset-0 z-[200] bg-white overflow-y-auto">
        <div class="min-h-screen flex flex-col">
            ...
            <!-- Tab Toggle -->
            <div class="flex mx-6 bg-slate-100 rounded-xl p-1 mb-3">
                <button id="tab-login-btn" onclick="showAuthTab('login')"
                    class="flex-1 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider transition-all bg-white text-slate-900 shadow-sm">
                    Login
                </button>
            ...
            <!-- LOGIN FORM -->
            <div id="auth-login" class="px-6 flex flex-col gap-2.5">
                ...
                <button onclick="logIn()"
                    class="w-full bg-orange-500 text-white py-3 rounded-xl font-black text-xs uppercase tracking-wider mt-1 active:scale-[0.98] transition-transform shadow-lg shadow-orange-500/20">
                    Login
                </button>
            ...
            <!-- SIGNUP FORM -->
            <div id="auth-signup" class="hidden px-6 flex flex-col gap-2.5">
                <div class="flex flex-col gap-1.5">
                        ...
                        <div class="bg-[#f8fafc] border border-gray-100 p-3 rounded-[1.5rem] grid grid-cols-3 gap-y-3 gap-x-1 text-center shadow-sm">
                            ...
                            <div onclick="handleInstallApp()" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-16 h-16 bg-white rounded-[1.5rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fas fa-download text-xs text-[#f97316]"></i>
                                </div>
