            ...
            <div id="content-area">
                ...
                <div id="view-offers" class="hidden space-y-6">
                    <div>
                        ...
                        <!-- Static Tasks — always visible -->
                        <div id="static-tasks-container" class="space-y-3">
                        ...
                        <!-- Dynamic Tasks from Admin DB -->
                        <div id="app-install-container" class="space-y-3 mt-3 hidden"></div>

                        <div id="empty-earn-placeholder" class="py-10 text-center hidden">
