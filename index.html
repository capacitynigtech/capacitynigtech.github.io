...
<head>
    ...
    <style>
        ...
        /* Splash Screen Styles - Updated for Icon */
        #splash-screen {
            position: fixed;
            top: 0;
            left: 0;
...
<body class="pb-24">
    ...
    <div id="splash-screen">
        <img src="https://cdn-icons-png.flaticon.com/512/5542/5542154.png" alt="Capacity Hub" class="splash-icon">
        <div class="splash-welcome">Capacity Hub</div>
    </div>
