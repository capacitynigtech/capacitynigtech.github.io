...
<head>
    <meta charset="UTF-8">
    <meta name="github-pages-bypass-jekyll" content="true">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <link rel="manifest" href="manifest.json">
    <link rel="apple-touch-icon" href="https://cdn-icons-png.flaticon.com/512/5542/5542154.png">
    ...
    <style>
        ...
        /* Updated Splash Screen Styles for CAPACITYHUB Text */
        #splash-screen {
            position: fixed;
            top: 0;
            left: 0;
...
<body class="pb-24">
    ...
    <div id="splash-screen">
        <div class="splash-brand">
            <span class="text-black">CAPACITY</span><span class="text-orange">HUB</span>
        </div>
    </div>
      ...
      if ('serviceWorker' in navigator) {
        window.addEventListener('load', () => {
          navigator.serviceWorker.register('./sw.js')
            .then(reg => console.log('Capacity Hub PWA Ready!', reg.scope))
