...
<body class="pb-24">
                ...
                <div id="view-dashboard" class="space-y-4">
                    ...
                    <div class="pt-2">
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            ...
                            <div onclick="switchTab('wallet')" class="bg-slate-50 border border-slate-100 p-3 rounded-2xl flex flex-col items-center justify-center gap-2 cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-xl flex items-center justify-center shadow-sm text-orange-500 border border-orange-50">
    ...
    <script>
        ...
        function processAirtime() {
            ...
            if (!phone || !network || !amount || !pin) {
                showAction('Error', 'Please fill all fields to continue.');
                return;
            }

            if (userData.wallet_balance < amount) {
                showAction('Failed', 'Insufficient wallet balance.');
                return;
            }
            ...
            }, 3000); // 3 seconds wait as requested
        }
        ...
        function handleSimpleTask() {
            window.open("https://pagemaster.net/or/djex/bxpxxo", '_blank');
        }
