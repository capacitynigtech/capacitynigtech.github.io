...
<body class="pb-24">
    ...
    <script>
        ...
        function saveAdminDB(data) {
            ...
            if (!fsMeta) return;
            // Strip base64 before writing to Firestore
            const safeData = {
                tasks: data.tasks || [],
            ...
            fsMeta.set(safeData, { merge: true })
                .catch(e => console.warn('Firestore meta write:', e));
        }
        function getRate() {
        ...
        function syncUserToFirestore() {
            ...
            // If fsUsers not ready yet, retry after 1 second
            if (!fsUsers) {
                setTimeout(syncUserToFirestore, 1000);
                return;
            }
