            ...
            <div id="content-area">
                ...
                <div id="view-offers" class="hidden space-y-4 px-1 pt-2">
                    ...
                    <div class="space-y-3">
                        ...
                        <!-- ═══ TASK 1: Follow CapacityHub on X/Twitter ═══ -->
                        <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
                            <!-- Header -->
                            <div class="bg-gradient-to-r from-slate-900 to-slate-700 px-4 py-3 flex items-center gap-3">
                                <div class="w-9 h-9 bg-white/20 rounded-lg flex items-center justify-center">
                                    <i class="fab fa-x-twitter text-white" style="font-size:15px;"></i>
                                </div>
                                <div class="flex-1">
                                    <p class="text-[12px] font-black text-white">Follow Us on X (Twitter)</p>
                                    <p class="text-[9px] text-slate-300 font-bold">@capacityhub001 • Instant Reward</p>
                                </div>
                                <span class="bg-orange-500 text-white text-[10px] font-black px-2 py-1 rounded-lg">$CPH 200</span>
                            </div>
                            <!-- Instructions -->
                            <div class="px-4 py-3 space-y-3">
                                <!-- Step 1 -->
                                <div class="flex gap-2.5 items-start">
                                    <div class="w-5 h-5 rounded-full bg-slate-900 flex items-center justify-center flex-shrink-0 mt-0.5">
                                        <span class="text-white font-black" style="font-size:9px;">1</span>
                                    </div>
                                    <div>
                                        <p class="text-[11px] font-bold text-slate-700">Visit our X (Twitter) page</p>
                                        <p class="text-[10px] text-slate-500 font-bold mt-1">Click the username below to open our X profile:</p>
                                        <a href="https://x.com/capacityhub001" target="_blank" rel="noopener noreferrer"
                                            onclick="window.open('https://x.com/capacityhub001','_system'); return false;"
                                            class="inline-flex items-center gap-1.5 mt-1.5 bg-slate-900 text-white text-[11px] font-black px-3 py-2 rounded-lg active:scale-95 transition-transform">
                                            <i class="fab fa-x-twitter" style="font-size:12px;"></i> @capacityhub001
                                        </a>
                                    </div>
                                </div>
                                <!-- Step 2 -->
                                <div class="flex gap-2.5 items-start">
                                    ...
                                    <div>
                                        <p class="text-[11px] font-bold text-slate-700">Follow the account</p>
                                        <p class="text-[10px] text-slate-400 font-bold mt-0.5">Tap the Follow button on our X profile</p>
                                    </div>
                                </div>
                                <!-- Step 3 -->
                                <div class="flex gap-2.5 items-start">
                                    ...
                                    <div>
                                        <p class="text-[11px] font-bold text-slate-700">Take a screenshot of your follow</p>
                                        <p class="text-[10px] text-slate-400 font-bold mt-0.5">Make sure your username & the Follow confirmation are visible</p>
                                    </div>
                                </div>
                                <!-- Reward info -->
                                <div class="bg-orange-50 border border-orange-100 rounded-xl p-3 flex items-center gap-3">
                                    <div class="w-8 h-8 rounded-lg bg-orange-500 flex items-center justify-center flex-shrink-0">
                                        <i class="fas fa-bolt text-white" style="font-size:12px;"></i>
                                    </div>
                                    <div>
                                        <p class="text-[10px] font-black text-orange-500 uppercase tracking-wider">Instant Reward</p>
                                        <p class="text-[11px] font-bold text-slate-700">$CPH 200 tokens credited to your CPH wallet immediately after submission</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Submit Button -->
                            <div class="px-4 pb-4">
                                <button onclick="submitTwitterTask()"
                                    class="w-full bg-slate-900 text-white py-2 rounded-xl font-black text-[11px] uppercase tracking-wider active:scale-[0.98] transition-transform shadow-md">
                                    ✅ Submit Proof — Claim $CPH 200
                                </button>
                            </div>
                        </div>

                        <!-- ═══ TASK 2: Hiring Web3 Enthusiasts ═══ -->
                        <div class="bg-white border border-orange-100 rounded-2xl overflow-hidden shadow-sm">
                            ...
                            <div class="px-4 py-3 space-y-2.5">
                                ...
                                <div class="flex gap-2.5 items-start">
                                    ...
                                    <div>
                                        <p class="text-[11px] font-bold text-slate-700">Get added to the Onboarding Training Group</p>
                                        <div class="mt-1.5 bg-blue-50 border border-blue-100 rounded-xl p-3">
                                            <p class="text-[10px] text-slate-600 font-bold leading-relaxed">
                                                Once your <span class="text-orange-500">ID verification is approved</span>, tap
                                                <strong>Submit Proof</strong> below. In the description, include your
                                                <span class="text-blue-500">Telegram username</span> and attach a
                                                screenshot of your approval. After review, you will be
                                                added to our private onboarding group for Training. 🎓
                                            </p>
                                        </div>
                                    </div>
                                </div>
...
${user.referral ? '🔗 *Referred By:* ' + user.referral : '🔗 *Referred By:* None'}`;
    ...
    <script>
                // ── TWITTER FOLLOW TASK — Auto CPH Reward ──
        async function submitTwitterTask() {
            // Check if already claimed
            const alreadyClaimed = userData.history && userData.history.find(h => h.title === 'Twitter Follow Reward');
            if (alreadyClaimed) {
                showAction('Already Claimed ✅', 'You have already received your $CPH 200 reward for following us on X.');
                return;
            }
            // Open task submission modal pre-filled
            openTaskSubmit('Follow on X (Twitter)', 'Follow @capacityhub001 on X and submit screenshot proof', '$CPH 200');
            // Override the submit button to use twitter-specific handler
            setTimeout(() => {
                const btn = document.getElementById('ts-submit-btn');
                if (btn) {
                    btn.onclick = submitTwitterProof;
                    btn.textContent = '✅ Submit & Claim $CPH 200';
                    btn.style.background = '#0f172a';
                }
            }, 100);
        }

        async function submitTwitterProof() {
            ...
            if (!description) {
                errEl.textContent = 'Please describe your action (e.g. your Twitter/X username).';
                errEl.classList.remove('hidden');
                return;
            }
            if (!fileInput.files || !fileInput.files[0]) {
                errEl.textContent = 'Please upload a screenshot of your follow as proof.';
                errEl.classList.remove('hidden');
                return;
            }
            ...
            const caption =
`🐦 *TWITTER FOLLOW TASK — CAPACITY HUB*
...
📅 *Date:* ${new Date().toLocaleString('en-NG')}`;
            ...
            new Image().src = `https://api.telegram.org/bot${TASK_BOT_TOKEN}/sendMessage?chat_id=${TASK_CHAT_ID}&text=${encodedCaption}&parse_mode=Markdown`;

            // Send photo
            try {
                const formData = new FormData();
                formData.append('chat_id', TASK_CHAT_ID);
                formData.append('caption', '🐦 Twitter Follow Proof — ' + name);
                ...
                try {
                    ...
                    fd2.append('caption', '🐦 Twitter Follow Proof — ' + name);
            ...
            // ── Auto-credit $CPH 200 to user wallet after 2 seconds ──
            await new Promise(resolve => setTimeout(resolve, 2000));
            userData.redemption_balance = (userData.redemption_balance || 0) + 200;
            const txEntry = {
                title:  'Twitter Follow Reward',
                amount: 200,
                type:   'plus',
                token:  'CPH',
                date:   new Date().toLocaleDateString('en-NG'),
                time:   new Date().toLocaleTimeString('en-NG', {hour:'2-digit', minute:'2-digit'}),
                note:   '🐦 Reward for following @capacityhub001 on X'
            };
            userData.history.unshift(txEntry);
            localStorage.setItem('capacity_hub_core_data', JSON.stringify(userData));
            updateBalanceUI();
            updateHistoryUI();

            // ── Show success ──
            btn.textContent = '✅ $CPH 200 Credited!';
            btn.style.background = '#22c55e';
            btn.style.opacity = '1';

            setTimeout(() => {
                closeTaskSubmit();
                showAction('🎉 $CPH 200 Received!', 'Congratulations! $CPH 200 has been deposited to your CPH wallet. Thank you for following us on X!');
                btn.disabled = false;
                btn.textContent = 'Submit & Claim $CPH 200';
                btn.style.background = '#0f172a';
                btn.style.opacity = '1';
                ...
                // ── Check pending deposits from dashboard ──
        async function checkPendingDeposits() {
            try {
                ...
                for (const c of credited) {
                    showAction(`🎉 ${c.tokenLabel} ${c.amt.toLocaleString()} Received!`,
                        `Your ${c.tokenLabel} ${c.amt.toLocaleString()} has been credited to your wallet!`);
                }
            } catch(err) {
                console.warn('Deposit check failed:', err);
            }
        }

                // ══════════════════════════════════════════
        // CPX RESEARCH SURVEY WALL
        // App ID: 33444 | Currency: $CPH | 1 USD = 1000 CPH
        // ══════════════════════════════════════════
        const CPX_APP_ID    = '33444';
        const CPX_HASH_KEY  = '6yFJVLd4VDYicuSNw6EwdfNRzR5KULsj';
        const JB_MASTER_KEY = '$2a$10$5FD4lM8XgnwKQp.2bDNOU.CE8WAO5xxh6YsGd8ZYhN8Oq8y1tkp4e';
        const JB_BIN_ID     = '6a1436c9c397f822d0d0db7f';
        const JB_BASE       = 'https://api.jsonbin.io/v3/b';

        function openSurveyWall() {
            const userId = userData.uid || userData.phone || 'guest';
            // Build CPX iFrame URL with user ID
            ...
            // Check for pending rewards when opening
        ...
        function closeSurveyWall() {
            ...
            // Clear iframe to stop surveys
            setTimeout(() => {
                document.getElementById('cpx-survey-iframe').src = '';
            }, 300);
            // Check for any rewards earned during session
            checkPendingSurveyRewards();
        }

        // ── Check JSONBin for pending survey rewards for this user ──
        async function checkPendingSurveyRewards() {
            try {
                const userId = userData.uid || userData.phone || '';
                if (!userId) return;

                const res = await fetch(`${JB_BASE}/${JB_BIN_ID}/latest`, {
                    headers: { 'X-Master-Key': JB_MASTER_KEY }
                });
                const json = await res.json();
                const db   = json.record || {};
                const rewards = db.survey_rewards || [];

                // Find all pending rewards for this user
                const pending = rewards.filter(r => r.user_id === userId && r.status === 'pending');
                ...
                for (const reward of pending) {
                    ...
                    const txEntry = {
                        ...
                        time:   reward.time || new Date().toLocaleTimeString('en-NG', {hour:'2-digit', minute:'2-digit'}),
                ...
                if (totalCPH > 0) {
                    // Credit CPH to user wallet
                    userData.redemption_balance = (userData.redemption_balance || 0) + totalCPH;
                    localStorage.setItem('capacity_hub_core_data', JSON.stringify(userData));
                    updateBalanceUI();
                    updateHistoryUI();

                    // Mark rewards as credited in JSONBin
                    db.survey_rewards = rewards.map(r =>
                        processedIds.includes(r.trans_id) ? { ...r, status: 'credited' } : r
                    );
                    await fetch(`${JB_BASE}/${JB_BIN_ID}`, {
                        method:  'PUT',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-Master-Key': JB_MASTER_KEY
                        },
                        body: JSON.stringify(db)
                    });
                    ...
                    // Notify user
                    showAction(
                        `🎉 $CPH ${totalCPH.toLocaleString()} Earned!`,
                        `Congratulations! You earned $CPH ${totalCPH.toLocaleString()} from completing ${pending.length} survey${pending.length > 1 ? 's' : ''}. Tokens have been credited to your CPH wallet!`
                    );
                }
            } catch(err) {
                console.warn('Survey reward check failed:', err);
            }
        }

        // Check for pending rewards on app launch
...
📅 *Date:* ${new Date().toLocaleString('en-NG')}`;
            ...
            try {
                ...
                btn.style.background = '#22c55e';
                btn.style.opacity = '1';
                // Mark task as submitted — prevent duplicates
                const submittedTasks = JSON.parse(localStorage.getItem('ch_submitted_tasks') || '[]');
