                        ...
                        <div class="bg-[#f8fafc] border border-gray-100 p-3 rounded-[1.5rem] grid grid-cols-3 gap-y-3 gap-x-1 text-center shadow-sm">
                            ...
                            <div onclick="switchTab('offers')" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fas fa-robot text-sm text-[#f97316]"></i>
                                </div>
                            ...
                            <div onclick="handleInstallApp()" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fas fa-download text-sm text-[#f97316]"></i>
                                </div>
                            ...
                            <div onclick="switchTab('offers')" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fas fa-dice text-sm text-[#f97316]"></i>
                                </div>
                            ...
                            <div onclick="switchTab('offers')" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fab fa-bitcoin text-sm text-[#f97316]"></i>
                                </div>
                            ...
                            <div onclick="switchTab('offers')" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fas fa-graduation-cap text-sm text-[#f97316]"></i>
                                </div>
                            ...
                            <div onclick="switchTab('offers')" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fas fa-chart-line text-sm text-[#f97316]"></i>
                                </div>
                            ...
                            <div onclick="switchTab('offers')" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fas fa-gamepad text-sm text-[#f97316]"></i>
                                </div>
                            ...
                            <div onclick="handleSimpleTask()" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fas fa-check-circle text-sm text-[#f97316]"></i>
                                </div>
                            ...
                            <div onclick="switchTab('offers')" class="flex flex-col items-center cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50">
                                    <i class="fas fa-cubes text-sm text-[#f97316]"></i>
                                </div>
                    ...
                    <div class="pt-2">
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            <div onclick="openAirtimeModal()" class="bg-slate-50 border border-slate-100 p-3 rounded-2xl flex flex-col items-center justify-center gap-2 cursor-pointer active:scale-95 transition-transform">
                                <div class="w-9 h-9 bg-white rounded-[0.75rem] flex items-center justify-center shadow-[0_8px_24px_rgba(0,0,0,0.03)] border border-slate-100/50 text-[#f97316]">
