                ...
                <div id="view-offers" class="hidden space-y-6">
                    <div>
                        ...
                        <div id="app-install-container" class="space-y-3 hidden">
                            <div class="bg-slate-50 border border-slate-100 p-4 rounded-2xl cursor-pointer active:bg-slate-100">
                                ...
                                <button onclick="openTaskSubmit('Meta Earth Wallet', 'Install & Verify KYC', '₦500')" class="w-full bg-orange-500 text-white py-1.5 rounded-lg font-black text-[10px] uppercase tracking-wider active:scale-[0.98] transition-transform">
                                    Submit Proof
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="bg-slate-50 border border-slate-100 p-4 rounded-2xl cursor-pointer active:bg-slate-100">
                            <div class="flex items-center justify-between mb-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-[11px] font-bold text-slate-800">Testing</p>
                                        <p class="text-[9px] text-slate-500">Testing the task proof submission</p>
                                    </div>
                                </div>
                                <span class="text-[10px] font-black text-orange-500">₦0</span>
                            </div>
                            <button onclick="openTaskSubmit('Testing', 'Testing the task proof submission', '₦0')"
